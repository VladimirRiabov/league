...
class TableContr: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, moveRowAt sourceIndexPath: IndexPath, to destinationIndexPath: IndexPath) {
        ...
        tableView.footerView(forSection: sourceIndexPath.section)?.textLabel?.text = String("Summ of players: \(teams[sourceIndexPath.section].players.count)")
        tableView.footerView(forSection: destinationIndexPath.section)?.textLabel?.text = String("Summ of players: \(teams[destinationIndexPath.section].players.count)")
